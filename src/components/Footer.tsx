    ...
    <footer className="border-t bg-background">
      <div className="container px-4 py-8 mx-auto">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Breaking language barriers with AI-powered video translation. Reach global audiences with natural voice quality.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 mt-8 border-t">
          <p className="text-sm text-muted-foreground">
            © {currentYear} EchoLang. All rights reserved.
          </p>
